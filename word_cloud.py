...
parser = argparse.ArgumentParser(prog="Artist Wordcloud", description="Create a word cloud based upon your top artists from last.fm.")
...
parser.add_argument("-c", "--colour", type=str, nargs='?', const="Reds_r", help="A colour for your text to appear in, defaults to red. Some useful values: Blues, Greens, Blues, Greys, and Purples. Full list can be found in the colour_values.txt file.")
...
def generate_wordcloud(data: dict, colour: str, mask: str):
    wordcloud = WordCloud(width=1800, height=1200, min_font_size=2, prefer_horizontal=0.55, relative_scaling=1, colormap=colour, mask=mask).generate_from_frequencies(data)
    return wordcloud
